...
class Ui_Dialog(object):        
    ...
    def setTable1(self):
        ...
        labels = ['alternaria brassicicola', 'agaricus auricolor', 'agaricus brunneofibrillosus', 'agaricus californicus', 'agaricus crocodilinus', 'agaricus fissuratus', 'agaricus julius', 'agaricus kriegeri', 'agaricus nanaugustus', 'agaricus placomyces']
        row = len(labels)
        for y in range(row):
    ...
    def setTable2(self):
        ...
        labels = ["agaricus campestris", "alternaria brassicicola"]
        row = len(labels)
        for y in range(row):
